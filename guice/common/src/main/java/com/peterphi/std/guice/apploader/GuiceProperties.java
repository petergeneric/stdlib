...
public class GuiceProperties
{
	...
	@Doc("If set, the AuthScope id to use for unannotated web methods. If changed, allows different security constraints to be applied to unannotated Web Methods  (defaults to '" + AuthConstraint.DEFAULT_ID + "')")
