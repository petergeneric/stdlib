...
public class OkHttpClientBuilder implements ClientHttpEngineBuilder
{
	...
	{
		final ResteasyClientFactoryImpl.AuthScope scope = cred.scope();

		if (cred instanceof ResteasyClientFactoryImpl.BearerTokenCredentials)
		{
			ResteasyClientFactoryImpl.BearerTokenCredentials token = (ResteasyClientFactoryImpl.BearerTokenCredentials)cred;

			final BearerGenerator generator = token.token();
		...
		else if (cred instanceof ResteasyClientFactoryImpl.UsernamePasswordCredentials)
		{
			ResteasyClientFactoryImpl.UsernamePasswordCredentials passwd = (ResteasyClientFactoryImpl.UsernamePasswordCredentials) cred;
