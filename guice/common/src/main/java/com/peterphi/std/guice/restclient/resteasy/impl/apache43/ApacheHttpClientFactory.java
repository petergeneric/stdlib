...
{
	private record ClientFeatures(boolean fastFail, boolean cookies)
	{
	}
	...
	{
		var key = new ClientFeatures(fastFail, cookies);
		var client = clients.computeIfAbsent(key, this :: createClient);
		if (client == null)
