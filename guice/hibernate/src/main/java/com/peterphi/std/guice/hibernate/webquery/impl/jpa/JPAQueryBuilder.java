...
public class JPAQueryBuilder<T, ID> implements JPAQueryBuilderInternal
{
	...
	private Object parseValue(final Expression property, final String value)
	{
		...
		if (clazz == Enum.class)
		{
			...
			// But hibernate no longer gives us this information, it only preserves the base abstract entity for subclasses
			throw new IllegalArgumentException("Cannot determine concrete enum type for: " + property);
		}
		else
		{
