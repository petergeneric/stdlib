<#-- @ftlvariable name="urls" type="com.mediasmiths.std.guice.web.rest.templating.freemarker.FreemarkerURLHelper" -->
<#-- @ftlvariable name="schemaGenerator" type="com.mediasmiths.std.guice.web.rest.service.servicedescription.freemarker.SchemaGenerateUtil" -->
<#-- @ftlvariable name="bootstrap" type="com.mediasmiths.std.guice.web.rest.util.BootstrapStaticResources" -->
<#-- @ftlvariable name="service" type="com.mediasmiths.std.guice.web.rest.service.servicedescription.freemarker.RestServiceInfo" -->
