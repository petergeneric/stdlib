...
class MultiXsdSchemaOutputter extends SchemaOutputResolver
{
	...
	/**
	 * Produces an XML Schema or a Mediasmiths SchemaFiles document containing the XML Schemas
	 *
	 * @return
	 */
	public String toString()
	{
		...
		else
		{
			...
			sb.append("<SchemaFiles xmlns=\"http://ns.mediasmithsforge.com/stdlib/xsd/multi-xsd\">");
