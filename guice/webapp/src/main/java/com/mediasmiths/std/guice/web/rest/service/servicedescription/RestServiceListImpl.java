...
import com.mediasmiths.std.guice.web.rest.service.servicedescription.freemarker.RestServiceInfo;
import com.mediasmiths.std.guice.web.rest.service.servicedescription.freemarker.SchemaGenerateUtil;
import com.mediasmiths.std.guice.web.rest.templating.TemplateCall;
import com.mediasmiths.std.guice.web.rest.templating.freemarker.FreemarkerTemplater;
import com.mediasmiths.std.guice.web.rest.templating.freemarker.FreemarkerURLHelper;
import com.mediasmiths.std.guice.web.rest.util.BootstrapStaticResources;
...
public class RestServiceListImpl implements RestServiceList
{
	...
	public RestServiceListImpl(Collection<RestResource> resources)
	{
		...
		config.setClassForTemplateLoading(RestServiceListImpl.class, "/com/mediasmiths/std/guice/web/rest/service/impl/");
