package com.mediasmiths.std.io.filter;
...
public class FilenameExtensionFilter implements FileFilter {
	 ...
	 * 
	 * @param extension the extension without the dot (e.g. "zip" should be used as the extension for zip files, "tar.gz" should be used as the extension for tar.gz files)
	 * @param caseSensitive true if matches should be case sensitive, otherwise false to perform case insensitive matching
	 ...
	 * 
	 * @param extensions the extensions without the dot (e.g. "zip" should be used as the extension for zip files, "tar.gz" should be used as the extension for tar.gz files)
	 * @param caseSensitive true if matches should be case sensitive, otherwise false to perform case insensitive matching
