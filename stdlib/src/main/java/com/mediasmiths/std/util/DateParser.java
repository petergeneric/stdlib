 ...
 * 
 * @version $Revision$
 * @author Benot Mah (bmahe@w3.org) Moved to com.mediasmiths.std.util (and slightly modified to use Calendar not Date) for ease of use from http://dev.w3.org/cvsweb/~checkout~/java/classes/org/w3c/util/DateParser.java?rev=1.5&content-type=text/plain
 */
public class DateParser {
	 ...
	 * 
	 * @param calendar a Date instance
