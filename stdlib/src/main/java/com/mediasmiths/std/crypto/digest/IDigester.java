...
public interface IDigester {
	...
	/**
	 * Digests a ByteChannel; the performance of this method <em>may possibly</em> be higher (but it may also be slightly slower) than that of the InputStream method
	 * 
	 * @param channel
	 * @return
	 */
