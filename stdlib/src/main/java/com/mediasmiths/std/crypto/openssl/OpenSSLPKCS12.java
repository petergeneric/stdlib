...
import com.mediasmiths.std.system.exec.*;
...
public class OpenSSLPKCS12 {
	 ...
	 * 
	 * @param p12 The PKCS12 Keystore to filter
	 * @param p12Password The password for the keystore
	 * @throws IOException if a catastrophic unexpected failure occurs during execution
	 * @throws IllegalArgumentException if the PKCS12 keystore doesn't exist
	 * @throws IllegalStateException if openssl exits with a failure condition
	 */
	 ...
	 * @param pemPassword The password for any encrypted keys in the PEM
	 * @param toP12 The PKCS12 file
	 * @param p12Password the password to put on the PKCS12 keystore
	 * @throws IOException if a catastrophic unexpected failure occurs during execution
	 * @throws IllegalArgumentException if the PEM keystore doesn't exist
	 * @throws IllegalStateException if openssl exits with a failure condition
	 */
