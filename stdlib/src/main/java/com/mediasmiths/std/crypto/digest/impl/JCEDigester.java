...
public class JCEDigester extends AbstractDigester {
	...
	/**
	 * @see com.mediasmiths.std.crypto.digest.impl.AbstractDigester#makeDigest(byte[])
	 */
	@Override
	...
	/**
	 * @see com.mediasmiths.std.crypto.digest.impl.AbstractDigester#makeDigest(java.io.InputStream)
	 */
	@Override
	...
	/**
	 * @see com.mediasmiths.std.crypto.digest.impl.AbstractDigester#makeDigest(java.nio.channels.ByteChannel)
	 */
	@Override
