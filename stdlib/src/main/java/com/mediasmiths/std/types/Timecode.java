...
public class Timecode
{
	...
	/**
	 * Returns the timecode in the Mediasmiths Tiemcode format. The format of this timecode is <code>smpte timecode@rate</code>
	 * where
	 ...
	 * @return
	 */
	public String toMediasmithsString()
	{
	...
	/**
	 * Parse a Timecode encoded in the "mediasmiths style" (<code>[-][dd:]hh:mm:ss:ff@timebase</code>). See {@link
