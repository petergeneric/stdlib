...
public class Either<L, R> {
	...
	/**
	 * 
	 * @param left optional; if specified then right must be null
	 * @param right optional; if specified then left must be null
	 * @throws IllegalArgumentException if both are null or both are non-null
	 */
