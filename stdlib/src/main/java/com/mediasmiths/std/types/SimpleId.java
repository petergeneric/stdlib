...
public final class SimpleId extends Id implements Serializable
{
	...
	/**
	 * Generates a random sequence of alphanumeric characters of length <code>length</code> using a new pseudorandom number generator (<code>new Random()</code>)
	 * 
	 * @param length
	...
	/**
	 * Generates a random sequence of alphanumeric characters of length <code>length</code> using the provided random number generator
	 * 
	 * @param random
