...
/**
 * A class encapsulating the Runnable idea, mixed with Callable - instead of having a return type, this takes an argument to be passed to the <code>run</code> method<br />
 * 
 * 
 * 
