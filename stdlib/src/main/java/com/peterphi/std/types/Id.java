 ...
 * All implementations must directly extend this type (ie. all people who extend this type should mark their implementation as final)<br />
 * It is not permitted to add any additional fields to an Id field: the sole benefit of extending an Id type is to provide clarity to what kind of Id something is<br />
...
public abstract class Id implements Comparable<Id>, Serializable{
	 ...
	 * 
	 * @param id the id value to use (may not be null)
	 */
	...
	/**
	 * Compares another Id to this id. Two ids are only comparable if they have the exact same type: if their types are incompatible then a ClassCastException will be thrown<br />
