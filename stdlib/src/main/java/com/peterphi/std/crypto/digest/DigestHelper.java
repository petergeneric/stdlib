...
public class DigestHelper {
	...
	public static String sha1(InputStream is, int encoding) throws FileNotFoundException, IOException,
	...
	public static String digest(final InputStream is, final String algorithm, final int encoding) throws IOException,
	NoSuchAlgorithmException {
