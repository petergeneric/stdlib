...
// Public Domain base64 implementation from http://iharder.net/base64
 ...
 * line feeds unless explicitly told to do so. I've got Base64 set the opposite way so that you tell it _not_ to add line feeds
 * since I always thought line feeds were required -- I was wrong, but I'm reluctant to change the default behavior now. Sorry.
 * </p>
 * <p/>
 * <p>
...
public class Base64
{
	 ...
	 * specifying that is was encoded using the URL-
	 ...
	 * accomodate <var>srcOffset</var> + 3 for the
	 * <var>source</var> array or <var>destOffset</var> + 4 for the <var>destination</var> array. The actual number of significant
	 ...
	 * <var>destination</var>. The source and destination arrays can be manipulated anywhere along their length by specifying
	 * <var>srcOffset</var> and <var>destOffset</var>. This method does not check to make sure your arrays are large enough to
	 * accomodate <var>srcOffset</var> + 4 for the
	 * <var>source</var> array or <var>destOffset</var> + 3 for the <var>destination</var> array. This method returns the actual
	 ...
	 * Special case: if len = 0, an empty array is returned. Still, if you need more quantity and reduced memory footprint (and
	 * aren't gzipping), consider this
	 * method.
	 *
	 * @param source
